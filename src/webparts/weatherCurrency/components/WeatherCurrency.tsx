...
import styles from './WeatherCurrency.module.scss';
import { IWeatherCurrencyProps } from './IWeatherCurrencyProps';
...
export default class WeatherCurrency extends React.Component<IWeatherCurrencyProps, IWeatherCurrencyState, {}> {
  ...
  public GetCurrencyValue() {
    ...
    myHeaders.append("apikey", "XgHz7JRmBnZ1rEMDiPiuNMRQiCI2Z4sJ");
  ...
  // private async GetCurrencySymbols() {
  //   var reactHandler = this;
  //   AvailableCurrencies = [];

  //   await NewWeb.lists.getByTitle("CurrencyMasterList").items.top(300).get().then((items) => { // //orderby is false -> decending          
  //     reactHandler.setState({  
  ...
  public render(): React.ReactElement<IWeatherCurrencyProps> {
    ...
    return (
      <div className={[styles.weatherCurrency, "m-b-20"].join(' ')} id="m-b-20-weather">
