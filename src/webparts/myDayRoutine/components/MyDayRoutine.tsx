...
import styles from './MyDayRoutine.module.scss';
import { IMyDayRoutineProps } from './IMyDayRoutineProps';
...
export default class MyDayRoutine extends React.Component<IMyDayRoutineProps, IMyDayRoutineState, {}> {
    private serviceProvider;
    public constructor(props: IMyDayRoutineProps, state: IMyDayRoutineState) {
        super(props);
    ...
    public getmytodaysroutines() {
        uniqueTime = [];
        uniqueCountItem = [];
        this.serviceProvider.getmytodaysroutine().then(
                (result: any[]): void => {
    ...
    public render(): React.ReactElement<IMyDayRoutineProps> {
        ...
        const AllMyEventsFuture: JSX.Element[] = this.state.myfutureroutineDatas.map(function(item,key) {
            ...
            if(item.isAllDay == false){
                ...
                if(reacthandler.state.IsCurrentFuture == ""){
                    ...
                    let isTeamsMeeting2:any = item.isOnlineMeeting;
                    if(reacthandler.state.SelectedDate !=""){
                        ...
                        if(isTeamsMeeting2 == true && moment(reacthandler.state.SelectedDate).format("DD-MM-YYYY") == moment(Starttime).local().format("DD-MM-YYYY") || moment(reacthandler.state.SelectedDate).format("DD-MM-YYYY") <= moment(Endtime).local().format("DD-MM-YYYY") ){
                            return(
                        ...
                        else if(isTeamsMeeting2 == false && moment(reacthandler.state.SelectedDate).format("DD-MM-YYYY") == moment(Starttime).local().format("DD-MM-YYYY") || moment(reacthandler.state.SelectedDate).format("DD-MM-YYYY") <= moment(Endtime).local().format("DD-MM-YYYY") ){
                            return(
                ...
                if(reacthandler.state.IsCurrentFuture == ""){
                    let isTeamsMeeting3:any = item.isOnlineMeeting;
                    if(isTeamsMeeting3 == true){
                        return(
                            <li className="clearfix relative" id={moment.utc(Starttime).local().format("DD-MM-YYYY")}>
                                <h5><img src={`${reacthandler.props.siteurl}/SiteAssets/Remo%20Portal%20Assets/img/clock.svg`} alt="Time"></img> <span className="fut-dt" style={{display:"none"}}>{localStartDate} </span>{localStart} - {localEnd}</h5><img className="seperator" src={`${reacthandler.props.siteurl}/SiteAssets/Remo%20Portal%20Assets/img/line.svg`} alt="line"></img>
                                <h4>{item.subject}</h4><img className="seperator" src={`${reacthandler.props.siteurl}/SiteAssets/Remo%20Portal%20Assets/img/line.svg`} alt="line"></img>
                    ...
                    let isTeamsMeeting4:any = item.isOnlineMeeting;
                    if(reacthandler.state.SelectedDate !=""){
                        var selecteddt = moment(reacthandler.state.SelectedDate).format("DD-MM-YYYY");
                        var tdaydt = moment().format("DD-MM-YYYY");
                        ...
                        if(isTeamsMeeting4 == true && moment(reacthandler.state.SelectedDate).format("DD-MM-YYYY") == moment(Starttime).local().format("DD-MM-YYYY") || moment(reacthandler.state.SelectedDate).format("DD-MM-YYYY") < moment.utc(Endtime).local().format("DD-MM-YYYY") ){
                            return(
                                <li className="clearfix relative same" id={stime}>
                                    <h5><img src={`${reacthandler.props.siteurl}/SiteAssets/Remo%20Portal%20Assets/img/clock.svg`} alt="Time"></img> {localStart} - {localEnd}</h5><img className="seperator" src={`${reacthandler.props.siteurl}/SiteAssets/Remo%20Portal%20Assets/img/line.svg`} alt="line"></img>
                                    <h4>{item.subject}</h4><img className="seperator" src={`${reacthandler.props.siteurl}/SiteAssets/Remo%20Portal%20Assets/img/line.svg`} alt="line"></img>
                        ...
                        else if(isTeamsMeeting4 == false && moment(reacthandler.state.SelectedDate).format("DD-MM-YYYY") == moment(Starttime).local().format("DD-MM-YYYY") || moment(reacthandler.state.SelectedDate).format("DD-MM-YYYY") < moment.utc(Endtime).local().format("DD-MM-YYYY") ){
                            return(
                                <li className="clearfix relative samefalse" id={stime}>
                                    <h5><img src={`${reacthandler.props.siteurl}/SiteAssets/Remo%20Portal%20Assets/img/clock.svg`} alt="Time"></img> {localStart} - {localEnd}</h5><img className="seperator" src={`${reacthandler.props.siteurl}/SiteAssets/Remo%20Portal%20Assets/img/line.svg`} alt="line"></img>
                                    <h4>{item.subject}</h4> 
        ...
        return (
            ...
            <div className={[styles.myDayRoutine, "m-b-20 m-b-50 m-b-routine clearfix"].join(' ')}>
