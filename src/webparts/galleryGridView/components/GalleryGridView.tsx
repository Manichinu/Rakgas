...
export default class GalleryGridView extends React.Component<IGalleryGridViewProps, IGalleryGridViewState, {}> {
  slider2: any;
  slider1: any;
  public constructor(props: IGalleryGridViewProps, state: IGalleryGridViewState) {
    super(props);
    this.state = {
      Images: [],
      Videos: [],
  ...
  // private async GetGalleryFilesFolder(triggeredFrom) {
  //   var reactHandler = this;
  //   var APIUrl;
  //   const url: any = new URL(window.location.href);
  //   const FolderUrl = url.searchParams.get("FolderName");
  ...
  //   if (triggeredFrom == "Main") {
  //     if (Type == "Img") {
  //       APIUrl = await NewWeb.getFolderByServerRelativeUrl('{FolderUrl}').files.expand("Folders", "Files").get();
  //     } else {
  //       APIUrl = await NewWeb.getFolderByServerRelativeUrl('{FolderUrl} + "/Videos"').files.expand("Folders", "Files").get();
  //     }
  ...
  //       var FolderPath = url.searchParams.get("FolderName").replace(/[']/g, '');
  //       var FolderServerRelativeUrl = "" + FolderPath + "/Videos";
  //       APIUrl = await NewWeb.getFolderByServerRelativeUrl(FolderServerRelativeUrl).files.expand("Folders", "Files").get();
  //     }
  //   }
  //   if (reactHandler.state.type == "Img") {
  //     $(".image-gallery-allimg-block").show();
 ...
 // }, 500);
  ...
  public GetImagesInsideFolder(FolderURL, Mode, key) {
    ...
    if (Mode == "Image") {
      ...
      if (string.indexOf(str2) != -1) {
        ...
        siteurl = "https://rakgasae.sharepoint.com/sites/Intranet/_api/Web/GetFolderByServerRelativeUrl('" + FolderServerRelativeUrl + "')?$select=ID,Title,FileRef,FileSystemObjectType,FileLeafRef,File/ServerRelativeUrl,File/Name&$expand=Folders,Files";
      }
    }
  ...
  // private async GetImagesInsideFolder(FolderURL, Mode, key) {
  //   var siteurl: any;
  //   this.setState({ FolderURL: FolderURL });
  //   $(".lightbox").addClass("open");
  //   var reactHandler = this;
  ...
  //     $("#trigger-image").hide();
  //     $("#trigger-video").show();
  //     siteurl = await NewWeb.getFolderByServerRelativeUrl('{FolderUrl}').select("ID","Title","FileRef","FileSystemObjectType","FileLeafRef","File/ServerRelativeUrl","File/Name").expand("Folders","Files")
  //     .get();
  ...
  //     var FolderPath = FolderURL.replace(/[']/g, '');
  //     var FolderServerRelativeUrl = "" + FolderPath + "/Videos";
  //     siteurl = await NewWeb.getFolderByServerRelativeUrl(FolderServerRelativeUrl).files.expand("Folders", "Files").get();
  //   }
  //   reactHandler.setState({
  //     FolderItems: siteurl
  //   });
              ...
              <div className="inner-banner-header relative m-b-20">
                ...
                <div className="inner-banner-contents">
                  ...
                  <ul className="breadcums">
                    ...
                    <li>  <a href="off" style={{ pointerEvents: "none" }} data-interception="off"> Grid View </a> </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="gallery-lightbox-contents">
              <div className="lightbox-contents-img">
                ...
                <div className="lightbox-close">
                  <img src={`${reactHandler.props.siteurl}/SiteAssets/Remo%20Portal%20Assets/img/close.svg`} alt="close" onClick={() => this.CloseLightBox()} />
