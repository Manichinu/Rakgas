...
import styles from './HeroBannerRm.module.scss';
import { IHeroBannerRmProps } from './IHeroBannerRmProps';
...
export default class HeroBannerRm extends React.Component<IHeroBannerRmProps, IHeroBannerRmState, {}> {
  constructor(props: IHeroBannerRmProps, state: IHeroBannerRmState) {
    super(props);
    this.state = {
      Items: [],
      ItemID: null
  ...
  public render(): React.ReactElement<IHeroBannerRmProps> {
    var handler = this;
    var Dte = "";
    ...
    return (
      <div className={styles.heroBannerRm}>
              ...
              <div className="inner-banner-header relative m-b-20">
                ...
                <div className="inner-banner-contents">
                  ...
                  <ul className="breadcums">
                    ...
                    <li>  <a href="#" style={{ pointerEvents: "none" }} data-interception="off"> Hero Banner ReadMore</a> </li>
                  </ul>
                </div>
              </div>
