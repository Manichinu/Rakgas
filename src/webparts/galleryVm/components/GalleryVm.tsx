...
import styles from './GalleryVm.module.scss';
import { IGalleryVmProps } from './IGalleryVmProps';
...
let ImgArr = [];
export default class GalleryVm extends React.Component<IGalleryVmProps,IGalleryVmState, {}> {
  slider2: any; 
  slider1: any;
  public lightGallery: any;
  public constructor(props: IGalleryVmProps, state: IGalleryVmState){    
    super(props);      
    this.state = {               
      Galleryitems: [],
      VideoItemsss:[],
...
public ShowHideVideos(FolderURL,Mode){
  ...
  public render(): React.ReactElement<IGalleryVmProps> {
    const settings = {
      dots: false,
      arrows: true,
      infinite: false,
              ...
              <div className="gallery-lightbox-contents">
                <div className="lightbox-contents-img">
                  <div className="lightbox-contents-header clearfix">
                    ...
                    <ul>
                      <li id="trigger-image" className={this.state.Mode=="Image" ? "imageblock":""} > <a href="#" onClick={()=>reactHandler.GetImagesInsideFolder(this.state.FolderURL,"Image")} data-interception="off"> Pictures  </a> </li>
                      ...
                      <li> <a href={this.props.siteurl+"/SitePages/Gallery-Grid-View.aspx?env=WebView&FolderName='"+this.state.FolderURL+"'&Type=Img"} data-interception="off"> Grid View  </a> </li>
                    </ul>
                  </div>
