...
import styles from './NewQuickLinkManager.module.scss';
import { INewQuickLinkManagerProps } from './INewQuickLinkManagerProps';
...
import {SortableContainer, SortableElement, arrayMove} from 'react-sortable-hoc';
      ...
      export interface INewQuickLinkManagerState {
        items:any[];
      ...
      const SortableItem = SortableElement(({value,i}) =>  {
        ...
        <input type="hidden" className="hdn-item-id" value={value.ID}></input>
          <a href="#"> <img src={JSON.parse(value.Items.ImageHover).serverRelativeUrl} alt="image" data-interception="off"/>
      ...
      const SortableList = SortableContainer(({items}) => {  
        return (
          <ul className="qq-links-part clearfix my-qlink-block">
            ...
            <li onClick={function(event){EnableEditMode()}} id="edit-mode-enabler"> <a href="#" className="add-quicklinks-link" data-interception="off">  <img src="https://rakgasae.sharepoint.com/sites/Intranet/SiteAssets/Remo%20Portal%20Assets/img/Plus-Add-Qlink.png" alt="image"/>
              <h5> Quick Links </h5>  </a>
            </li>
          </ul>
        );
...
export default class NewQuickLinkManager extends React.Component<INewQuickLinkManagerProps,INewQuickLinkManagerState, {}> {
  public constructor(props: INewQuickLinkManagerProps, state: INewQuickLinkManagerState){
    super(props);
   this.state = {
       items: [] ,
  ...
  public render(): React.ReactElement<INewQuickLinkManagerProps> {
    var reactHandler = this;
          ...
          <li> 
            <a href="#" data-interception="off">   <img src={`${ImgObj.serverRelativeUrl}`} alt="image"/>
              ...
              <div className="add-quicklinks">
                <img src="https://rakgasae.sharepoint.com/sites/Intranet/SiteAssets/Remo%20Portal%20Assets/img/add_quick.png" alt="image" onClick={()=>reactHandler.AddToMyQuickLinkPreference(item.ID)} />
              </div>
            </a>
          </li>
        );              
    ...
    return (
      <div className={ styles.newQuickLinkManager }>
         <section>
                  ...
                  <div className="added-quickis-part">  
                    <div className="heading clearfix">
                      ...
                      <div className="header-right drap-drop-p">
                        <img src="https://rakgasae.sharepoint.com/sites/Intranet/SiteAssets/Remo%20Portal%20Assets/img/drap_drop.png" alt="image" />  You can drag and drop to change position  
                        <span id="editMode" style={{display:"none"}}><a href="#" onClick={()=>reactHandler.ExitEditMode()} data-interception="off"> Exit Edit Mode </a></span>
                      </div> 
                    </div>
