...
import styles from './MyRecentFiles.module.scss';
import { IMyRecentFilesProps } from './IMyRecentFilesProps';
...
export default class MyRecentFiles extends React.Component<IMyRecentFilesProps,IMyRecentFilesState, {}> {
  private serviceProvider;
  public constructor(props: IMyRecentFilesProps, state: IMyRecentFilesState) {
    super(props);
  ...
  public calculateDynamicHeight(){    
      setTimeout(function(){
        ...
        let hse = document.getElementById('m-b-20-hse-events').offsetHeight;
        let TotalHeightLeft = nwsheight+socialHeight+videoHeight+HomeFooter+hse;
        ...
        let recognition = document.getElementById('recognition-web').offsetHeight;
        ...
        if (Focusthis.length) {
            ...
            TotalHeightRight = weatherHeight+Highlights+pQlinkHeight+recognition;

            TotalCalculatedHeight = TotalHeightLeft - TotalHeightRight+56;// - 37; 66;//47;//66 ;
            $("#dynamic-height-recentsfiles").css("height",""+TotalCalculatedHeight+"");
        }else{
            TotalCalculatedHeight = TotalHeightLeft - TotalHeightRight+56;// - 37;  47;//66 ;
            $("#dynamic-height-recentsfiles").css("height",""+TotalCalculatedHeight+"");
        }
      ...
      setTimeout(function(){
        ...
        if (Focusthis.length) {
            ...
            TotalCalculatedHeight = TotalHeightLeft - TotalHeightRight+56;// - 47;//66 ;
            $("#dynamic-height-recentsfiles").css("height",""+TotalCalculatedHeight+"");
        }
        //console.log("news:"+nwsheight+"Social:"+socialHeight+"Vide:"+videoHeight+"weath:"+weatherHeight+"Pqlink:"+pQlinkHeight+"bday:"+Highlights);
  ...
  public render(): React.ReactElement<IMyRecentFilesProps> {
