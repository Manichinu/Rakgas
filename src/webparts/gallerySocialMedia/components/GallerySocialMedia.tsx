...
import styles from './GallerySocialMedia.module.scss';
import { IGallerySocialMediaProps } from './IGallerySocialMediaProps';
...
export default class RemoGallerySocialMedia extends React.Component<IGallerySocialMediaProps, IRemoGallerySocialMediaState, {}> {
  public constructor(props: IGallerySocialMediaProps, state: IRemoGallerySocialMediaState) {
    super(props);
    this.state = {
      Items: [],
      Galleryitems: [],
                ...
                if (reactHandler.findValueInArrayVideos(foldernameval, FolderNamesVideo)) {
                  ...
                  if (y <= 2) {
                    $('.vdo-block-area').append(`  
                                    <li>
                                      <a className="relative image-hover-gal" href="${reactHandler.props.siteurl}/SitePages/Gallery-ViewMore.aspx?env=WebViewList&FolderName='${gFolderUrl}'&Type=Vdo" data-interception="off">
  ...
  public render(): React.ReactElement<IGallerySocialMediaProps> {
    var reactHandler = this;
    var x = 1;
    let y = 1;
          ...
          if (reactHandler.findValueInArray(foldernameval, FolderNamesExits)) {
            ...
            if (reactHandler.findValueInArray(foldernameval, FolderNames)) {
              ...
              if (x < 2) {
                return (
                  <li>
                    <a className="relative image-hover-gal" href={reactHandler.props.siteurl + "/SitePages/Gallery-Grid-View.aspx?env=WebViewList&FolderName='" + gFolderUrl + "'&Type=Img"} data-interception="off"> <img src={`${item.FileRef}`} alt={item.FileLeafRef} />
                      <p>{foldernameval} </p>
                    </a>
                  </li>
                );
    ...
    return (
      <div className={styles.gallerySocialMedia} id="social-and-gallery">
        <div className="images-social">
          <div className="row">
            <div className="col-md-6" id="if-gallery-present">
              <div className="sec event-cal image-videos">
                <div className="heading clearfix">
                  <h3> <a href={`${this.props.siteurl}/SitePages/Gallery-ViewMore.aspx?env=WebViewList`} data-interception="off"> Gallery </a> </h3>
            ...
            <div className="col-md-6">
              <div className="social-medial-wrap">
                ...
                <div className="main-social-media-block background" id="LINKEDIN">
                  ...
                  <iframe src='https://widgets.sociablekit.com/linkedin-page-posts/iframe/80767' width='100%' height='1000'></iframe>
                </div>
                <div className="main-social-media-block background social-twitter" id="TWITT" style={{ display: "none" }}>
                  {/* <iframe src='https://widgets.sociablekit.com/linkedin-page-posts/iframe/80767' width='100%' height='1000' style={{ width: "100%" }}></iframe>Tweets by RAKGasOfficial */}
                  <a className="twitter-timeline" href="https://twitter.com/RAKGasOfficial?ref_src=twsrc%5Etfw" ></a>
                </div>
