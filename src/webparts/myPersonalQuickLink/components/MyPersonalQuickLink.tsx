...
import styles from './MyPersonalQuickLink.module.scss';
import { IMyPersonalQuickLinkProps } from './IMyPersonalQuickLinkProps';
...
export interface IMyPersonalQuickLinkState{
  MyQuickLinksPrefference:any[];
  MyQuickLinkData:any[];
}

let Myqlink = [];
export default class MyPersonalQuickLink extends React.Component<IMyPersonalQuickLinkProps,IMyPersonalQuickLinkState, {}> {
  public constructor(props: IMyPersonalQuickLinkProps, state: IMyPersonalQuickLinkState){
    super(props);
    this.state = {
              ...
              $.ajax({
                ...
                $(".m-b-routine").removeClass("QLinktrue");
                  ...
                  if(RawImageTxt != "" && RawImageTxtHover != ""){
                    ...
                    $("#result").append(`<li>`+
                        `<a href='${resultData.d.results[0].URL.Url}' target=_blank class="clearfix">` +              
  ...
  public render(): React.ReactElement<IMyPersonalQuickLinkProps> {
    var reactHandler = this;
    return (
