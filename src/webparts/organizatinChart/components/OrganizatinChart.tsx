...
import styles from './OrganizatinChart.module.scss';
import { IOrganizatinChartProps } from './IOrganizatinChartProps';
...
var chart:any;
var Nodevals;
export interface IOrganizatinChartState{  
    template:string;
}
export default class OrganizatinChart extends React.Component<IOrganizatinChartProps,IOrganizatinChartState, {}> {
  public constructor(props: IOrganizatinChartProps, state: IOrganizatinChartState){  
    super(props); 
...
ChangeOrgChartTemplate=(SelectedVal)=>{
  ...
  public render(): React.ReactElement<IOrganizatinChartProps> {
    return (
      <div className={ styles.organizatinChart }>
        <section>
