...
import styles from './EventsVm.module.scss';
import { IEventsVmProps } from './IEventsVmProps';
...
const eventList = [];
export default class EventsVm extends React.Component<IEventsVmProps,IEventsVmState, {}> {
  public constructor(props: IEventsVmProps, state: IEventsVmState){
    super(props);
  ...
  public render(): React.ReactElement<IEventsVmProps> {
    var handler = this;           
